    ...
    <div class="container">
        ...
        <div class="table-wrapper-scroll-y my-custom-scrollbar">
            ...
            <table class="table table-bordered table-striped mb-0">
                ...
                <tbody>
                <c:forEach items="${requestScope.studentList}" var="obj">
                    <tr>
                        ...
                        <td><a href="edit?id=<c:out value='${obj.studentId}' />">Edit</a>
                            &nbsp;&nbsp;&nbsp;&nbsp; <a
                                    href="delete?id=<c:out value='${obj.studentId}' />">Delete</a></td>
                    </tr>
